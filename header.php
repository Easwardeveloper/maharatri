      ...
      <nav class="navbar">
        ...
        <div class="sigma_logo-wrapper">
          <a class="navbar-brand" href="index.php">
            <img src="assets/img/sree.png" alt="logo" style="height:134px;">
          </a>
        </div>
        <!-- Logo End -->

        <!-- Menu -->
        <div class="sigma_header-inner style-2 p-0 border-0">
          <div class="sigma_header-top">
            <div class="sigma_header-top-inner">
              <ul class="sigma_header-top-links">
                <li class="menu-item"> <a href="tel:98416 27471"> <i class="fal fa-phone"></i> 91 9841627471</a> </li>
                <li class="menu-item"> <a href="mailto:sreebagalamukhidevitemple@gmail.com"> <i class="fal fa-envelope"></i> sreebagalamukhidevitemple@gmail.com</a> </li>
              </ul>
              <!-- <ul class="navbar-nav">
                <li class="menu-item menu-item-has-children">
                  <a href="#">Event</a>
             ...
             <li class="menu-item menu-item-has-children">
              ...
              <P><b>Sre Suryamangalam</b><br>
Sree Suryamangalam Advaitha Veda Vidhya Peetam
Sree Bagalamukhi Devi Temple</P>
            </div>
          </div>
